...
C {devices/lab_pin.sym} 1370 -590 0 1 {name=l3 lab=vbg}
C {devices/code_shown.sym} 1810 -470 0 0 {name=dc_op
only_toplevel=false 
spice_ignore=false
...
C {devices/code_shown.sym} 2920 -660 0 0 {name=NGSPICE
only_toplevel=true
spice_ignore=true
value="
.option savecurrents
...
.endc
" }
C {devices/lab_pin.sym} 1240 -590 0 0 {name=l15 lab=porst}
...
.endc
"}
C {devices/code.sym} 1500 -120 0 0 {name=NGSPICE1
only_toplevel=true
spice_ignore=true
...
.endc
" }
C {devices/code.sym} 1500 150 0 0 {name=TT_MODELS
only_toplevel=true
...
"
spice_ignore=false}
C {devices/launcher.sym} 1880 -650 0 0 {name=h3
descr=Backannotate 
tclcommand="xschem annotate_op"}
C {devices/vdd.sym} 1300 -620 0 0 {name=l2 lab=VDD}
C {bandgap_1v_v01.sym} 1300 -580 0 0 {name=x1}
